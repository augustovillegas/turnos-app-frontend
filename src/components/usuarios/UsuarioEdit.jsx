...
export const UsuarioEdit = ({ usuario, usuarioId, onVolver }) => {
  ...
  }, [formValues, identificadorEfectivo, validateEmailUnique, showModal, persistirCambios]);
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        ...
        >
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <Button type="button" variant="secondary" onClick={solicitarSalida} disabled={isBusy} className="w-full sm:w-auto" data-testid="btn-cancelar">
